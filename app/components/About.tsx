...
export function About() {
  return (
    <section id="about" className="py-24 bg-background dark:bg-[#0F172A]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl mb-6 bg-linear-to-r from-foreground to-[#8B5CF6] bg-clip-text text-transparent font-bold">
          ...
          <div className="space-y-6">
            <div className="p-6 bg-card border border-border/60 rounded-xl dark:bg-linear-to-br dark:from-[#1E293B] dark:to-[#0F172A] dark:border-[#06B6D4]/30">
            ...
            <div className="p-6 bg-card border border-border/60 rounded-xl dark:bg-linear-to-br dark:from-[#1E293B] dark:to-[#0F172A] dark:border-[#8B5CF6]/30">
              <div className="flex items-start gap-4">
            ...
            <div className="p-6 bg-card border border-border/60 rounded-xl dark:bg-linear-to-br dark:from-[#1E293B] dark:to-[#0F172A] dark:border-[#3B82F6]/30">
              <div className="flex items-start gap-4">
        ...
        <div className="p-8 bg-linear-to-r from-[#06B6D4]/10 to-[#8B5CF6]/10 border border-border/60 rounded-2xl dark:border-[#06B6D4]/30">
          <div className="flex items-start gap-4">
